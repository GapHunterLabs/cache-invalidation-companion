package dev.gaphunter.cacheinvalidationcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.cacheinvalidationcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.cacheinvalidationcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Cache-Invalidation Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34014-cache-invalidation-companion/reviews"
